import 'package:project_smm/entities/favourites_entities/favourites_api/data_source/favourites_calls_remote_data.dart';
...
class FavouritesCallsRepository{

  static Future<Either<Failure,CallsModel>> favouritesCalls(ParamsModel params) async{
    try{
      final remoteCallsInfo = await FavouritesCallsData().fetch(params);
